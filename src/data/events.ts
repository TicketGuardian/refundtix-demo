...
export const events: Event[] = [
  // Concerts
  {
    ...
    category: "Concerts",
    ticketTypes: [
      { id: "concert-1-ga", name: "General Admission", price: 85, available: 500 },
      { id: "concert-1-floor", name: "Floor Seats", price: 150, available: 200 },
      { id: "concert-1-vip", name: "VIP Package", price: 250, available: 50 },
    ],
  },
  {
    id: "concert-2",
    ...
    category: "Concerts",
    ticketTypes: [
      { id: "concert-2-lawn", name: "Lawn Seating", price: 45, available: 1000 },
      { id: "concert-2-reserved", name: "Reserved Seating", price: 95, available: 400 },
      { id: "concert-2-box", name: "Box Seats", price: 175, available: 60 },
    ],
  },
  {
    id: "concert-3",
    ...
    category: "Concerts",
    ticketTypes: [
      { id: "concert-3-single", name: "Single Day Pass", price: 125, available: 5000 },
      { id: "concert-3-weekend", name: "Weekend Pass", price: 299, available: 3000 },
      { id: "concert-3-vip", name: "VIP Weekend", price: 599, available: 500 },
    ],
  },
  {
    id: "concert-4",
    ...
    category: "Concerts",
    ticketTypes: [
      { id: "concert-4-balcony", name: "Balcony", price: 65, available: 300 },
      { id: "concert-4-orchestra", name: "Orchestra", price: 110, available: 150 },
      { id: "concert-4-front", name: "Front Row", price: 200, available: 20 },
    ],
  },
  ...
  // Sports
  {
    ...
    category: "Sports",
    ticketTypes: [
      { id: "sports-1-upper", name: "Upper Level", price: 75, available: 800 },
      { id: "sports-1-lower", name: "Lower Level", price: 180, available: 400 },
      { id: "sports-1-courtside", name: "Courtside", price: 850, available: 40 },
    ],
  },
  {
    id: "sports-2",
    ...
    category: "Sports",
    ticketTypes: [
      { id: "sports-2-bleacher", name: "Bleacher Seats", price: 250, available: 1500 },
      { id: "sports-2-field", name: "Field Level", price: 550, available: 600 },
      { id: "sports-2-premium", name: "Premium Club", price: 1200, available: 100 },
    ],
  },
  {
    id: "sports-3",
    ...
    category: "Sports",
    ticketTypes: [
      { id: "sports-3-endzone", name: "End Zone", price: 95, available: 2000 },
      { id: "sports-3-sideline", name: "Sideline", price: 225, available: 1000 },
      { id: "sports-3-club", name: "Club Level", price: 450, available: 300 },
    ],
  },
  {
    id: "sports-4",
    ...
    category: "Sports",
    ticketTypes: [
      { id: "sports-4-promenade", name: "Promenade", price: 175, available: 800 },
      { id: "sports-4-loge", name: "Loge", price: 350, available: 500 },
      { id: "sports-4-courtside", name: "Courtside Box", price: 950, available: 50 },
    ],
  },
  ...
  // Theater
  {
    ...
    category: "Theater",
    ticketTypes: [
      { id: "theater-1-rear", name: "Rear Mezzanine", price: 89, available: 200 },
      { id: "theater-1-mezz", name: "Front Mezzanine", price: 159, available: 150 },
      { id: "theater-1-orchestra", name: "Orchestra", price: 229, available: 100 },
    ],
  },
  {
    id: "theater-2",
    ...
    category: "Theater",
    ticketTypes: [
      { id: "theater-2-balcony", name: "Balcony", price: 179, available: 180 },
      { id: "theater-2-mezz", name: "Mezzanine", price: 299, available: 120 },
      { id: "theater-2-premium", name: "Premium Orchestra", price: 449, available: 60 },
    ],
  },
  {
    id: "theater-3",
    ...
    category: "Theater",
    ticketTypes: [
      { id: "theater-3-ga", name: "General Admission", price: 35, available: 150 },
      { id: "theater-3-booth", name: "Booth Seating", price: 55, available: 40 },
      { id: "theater-3-front", name: "Front Row", price: 75, available: 20 },
    ],
  },
  {
    id: "theater-4",
    ...
    category: "Theater",
    ticketTypes: [
      { id: "theater-4-lawn", name: "Lawn", price: 25, available: 400 },
      { id: "theater-4-reserved", name: "Reserved", price: 65, available: 200 },
      { id: "theater-4-premium", name: "Premium", price: 95, available: 80 },
    ],
  },
];
