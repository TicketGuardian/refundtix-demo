        ...
        <Card className="mt-8">
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <p className="mt-1 text-xl font-bold text-neutral-900 font-mono">
                {orderNumber}
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">
                    Your e-tickets will be emailed to you shortly. You can also
                    access them in your account.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-neutral-600">
                    We'll send you a reminder before your event so you don't
                    miss it!
                  </p>
                </div>
              </div>
